...
<html>
	...
	<body"><center>
		...
		<br><center><h1 Style="font-family: Helvetica;">Cifrado AES</h1></center>
		<form class="formulario" method="post" action="funciones_aes.php">
			<h1>[1] Encriptar</h1>
			<div class="contenedor">
				...
				<i class="fas icon">Llave Secreta:</i>
				<div class="input-contenedor">
					<i class="fas fa-key icon"></i>
					<input type="text" placeholder="Llave Secreta" name="key">
				</div>
		...
		<br><br>
		<form action="funciones_aes.php" class="formulario" method="post">
			<h1>[2] Decifrar</h1>
			<div class="contenedor">
				<i class="fas icon">Llave Secreta:</i>
				<div class="input-contenedor">
					<i class="fas fa-key icon"></i>
					<input type="password" placeholder="Llave Secreta" name="key">
				</div>
