...
<html>
	...
	<body><center>
		...
		<br><center><h1 Style="font-family: Helvetica;">Cifrado Propio</h1></center>
		
		<form class="formulario" method="post" action="funciones_personal.php">
			<h1>[1] Encriptar</h1>
			<div class="contenedor">
				...
				<i class="fas icon">Llave:</i>
				<div class="input-contenedor">
					<i class="fas fa-key icon"></i>
					<input type="text" placeholder="Llave" name="key">
				</div>
				...
				<i class="fas icon">Contraseña solo letras:</i>
				<div class="input-contenedor">
					<i class="fas fa-key icon"></i>
					<input type="password" placeholder="Contraseña" name="clave" pattern="[a-zA-Z ]{2,254}">
				</div>	
				<input type="submit" value="Registrar (Encriptar)" class="button" name="registrar"><br><br>
			</div>
		</form>
		<br><br>
		<form action="funciones_personal.php" class="formulario" method="post">
			<h1>[2] Decifrar</h1>
			<div class="contenedor">
				<i class="fas icon">Contraseña cifrada:</i>
				<div class="input-contenedor">
					<i class="fas fa-key icon"></i>
					<input type="password" placeholder="Contraseña cifrada" name="clave" pattern="[a-zA-Z ]{2,254}">
				</div>	
